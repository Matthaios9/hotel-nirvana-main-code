            ...
            <div className="container">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        <Nav className="ml-auto">
                            <Nav.Link href="https://zutet.com/" target="_blank" className="remove">Portfolio</Nav.Link>
                            <Nav.Link href="https://github.com/Matthaios9" target="_blank" className="remove">Github</Nav.Link>
                        </Nav>
